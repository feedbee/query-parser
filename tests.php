...
use QueryParser\Parser\Expression\NotOperator as ParserNotOperator;
use QueryParser\Parser\Expression\OrOperator as ParserOrOperator;
use QueryParser\Parser\Expression\Phrase;
use QueryParser\Parser\Parser;
use QueryParser\Tree\Dumper;
...
$tests = array(
    ...
    '(проверка (трех "ФР1""ФР2)")слов' => new Container(array(
        new Group(array(
            new Literal('проверка'),
            new Group(array(
                new Literal('трех'),
